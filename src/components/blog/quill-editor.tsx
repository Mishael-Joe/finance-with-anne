...
// // Import useQuill dynamically to avoid SSR issues
// const DynamicQuill = dynamic(
//   async () => {
//     const { useQuill } = await import("react-quilljs");
//     return ({
...
//   // Define formats that the editor should support
//   const formats = [
//     "header",
//     "bold",
//     "italic",
...
//       // Add a placeholder while the image uploads
//       quill.insertText(range.index, "Uploading image...", {
//         color: "#999",
//         italic: true,
//       });
...
//   // Set up event handlers once quill is initialized
//   useEffect(() => {
//     if (quillInstance.current && !isInitializedRef.current) {
//       isInitializedRef.current = true;
...
//       toolbar.addHandler("image", imageHandler);
//     }
//   }, [quillInstance.current, value, onChange, imageHandler]);
