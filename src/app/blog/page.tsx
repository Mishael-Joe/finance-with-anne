...
export const metadata: Metadata = {
  ...
  description: "Read the latest articles on personal finance, budgeting, saving, and investing strategies.",
}
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      ...
      <section className="mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">Financial Wisdom Blog</h1>
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-lg text-muted-foreground">
            Practical advice and insights to help you master your finances and build wealth.
          </p>
        </div>
      </section>
